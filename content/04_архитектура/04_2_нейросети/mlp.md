...
aliases:
  ...
  - MLP
---
Многослойный персептрон (Multilayer perceptron, MLP) — глубокая нейросеть прямого распространения (feedforward), реализующая параметрическую функцию последовательной композицией полносвязных слоев и нелинейных активаций.
