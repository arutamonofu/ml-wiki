...
aliases:
  ...
  - GAN
---
Генеративно-состязательная сеть (generative adversarial network) — архитектура из двух параметрических сетей (генератора и дискриминатора), соревнующихся в антагонистической игре.
