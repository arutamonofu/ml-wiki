...
---
Свёрточная нейронная сеть (convolutional neural network) — архитектура для обработки пространственных сеточных данных путем иерархического применения локальных свёрток с разделяемыми весами.
